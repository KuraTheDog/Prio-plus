...
int send_DaBit_batch(const int sockfd,
...
int send_EdaBit_batch(const int sockfd, const EdaBit* const * const x,
...
int recv_EdaBit_batch(const int sockfd, EdaBit* const * const x,
    const size_t nbits, const size_t n) {
  int total = 0, ret;
  fmpz_t* r; new_fmpz_array(&r, n);
  bool* const b = new bool[n * nbits];

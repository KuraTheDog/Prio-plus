...
void makeLocalBoolTriple(BooleanBeaverTriple* const out0,
                         BooleanBeaverTriple* const out1) {
...
void makeLocalDaBit(DaBit* const bit0, DaBit* const bit1) {
  ...
  This case only happens odds ~1/p anyways,
    but since it's local we are free to adjust
  */

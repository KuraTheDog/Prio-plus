...
void run_sender(int sockfd) {
  ...
  std::cout << "send uint64[] \tsize: " << n << " \tval: ";
  std::cout << batch64[0] << ", " << batch64[1] << std::endl;
  ...
  */
  ...
  std::cout << "send btriple \tsize: " << n << " \tvals: " << btrip->a;
  std::cout << ", " << btrip->b << ", " << btrip->c << std::endl;
  delete btrip;
...
void run_receiver(int sockfd) {
  ...
  std::cout << "recv uint64[] \tsize: " << n << " \tval: ";
  std::cout << batch64[0] << ", " << batch64[1] << std::endl;
